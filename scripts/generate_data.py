...
def main():
    ...
    with open(OUT, "w", encoding="utf-8") as f:
        ...
        f.write('  money_market: "Money Market",\n  brokerage: "Brokerage",\n')
        f.write('  pension_comprehensive: "Pension", pension_supplementary: "Pension",\n')
        f.write('  provident: "Provident",\n  study_fund: "Study Fund",\n};\n\n')
        f.write('const GROUP_ORDER = ["Cash / Checking","Money Market","Brokerage","Pension","Provident","Study Fund"];\n\n')
